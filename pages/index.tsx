              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-slate-200">
                    &lt;Insert strap line for club here&gt;
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Member run</h6>
                    <p className="mt-2 mb-4 text-slate-500">
                      Colinton Castle is a member run squash and racketball club
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Juniors</h6>
                    <p className="mt-2 mb-4 text-slate-500">
                      For juniors we run group coaching on a Saturday morning.
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Everyone welcome</h6>
                    <p className="mt-2 mb-4 text-slate-500">
                      We run many team, individual competitions and leagues as
                      well as club nights for players of all abilities and all
                      ages.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <Link href="/squash-and-racketball">
                  <a className="font-bold text-slate-700 mt-8">See more</a>
                </Link>
              </div>
            ...
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                <h2 className="text-4xl font-semibold">
                  Here are our committee members
                </h2>
